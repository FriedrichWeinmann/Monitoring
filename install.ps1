<#
	.SYNOPSIS
		Installs the Monitoring Module from github
		
	.DESCRIPTION
		This script installs the Monitoring Module from github.
...
$BaseUrl = "https://github.com/<InsertUsernameHere>/Monitoring"
